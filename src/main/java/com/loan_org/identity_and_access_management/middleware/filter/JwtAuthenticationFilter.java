...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        // Next, find the jwt token and verify
        final String jwt = authHeader.substring(7);
        final String email = jwtVerificationService.extractEmail(jwt);
        final String role = jwtVerificationService.extractRole(jwt);

        if (email != null && SecurityContextHolder.getContext().getAuthentication() == null && jwtVerificationService.isTokenValid(jwt)) {
